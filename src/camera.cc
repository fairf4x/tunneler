...
extern Color mud_color;
extern Color rock_color;
...
void camera::shot(void)
{
	...
	/* optimalizace vykreslovani - snaha snizit pocet volani SDL_RenderFillRect
	...
	for(j = 0; j < visible_area.h; ++j)
	{
		...
		while(i < visible_area.w)
		{
			...
			switch(act)
			{
				...
				break;
				case MUD:
					SDL_SetRenderDrawColor(renderer, mud_color.r, mud_color.g, mud_color.b, mud_color.a);
					SDL_RenderFillRect(renderer,&ctv);
				break;
				case PATH:
				...
				break;
				case STRUCTURE:
					SDL_SetRenderDrawColor(renderer, stru_color.r, stru_color.g, stru_color.b, stru_color.a);
					SDL_RenderFillRect(renderer,&ctv);
				break;
				default:
				break;
